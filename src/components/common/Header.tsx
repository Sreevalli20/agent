            ...
            <div className="relative">
              ...
              {learnerDropdownOpen && (
                <div
                  ...
                  className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-[9998] animate-in fade-in slide-in-from-top-2 duration-150 text-left max-h-[80vh] overflow-y-auto"
                >
