...
export const SkillTagModal: React.FC<SkillTagModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-900/50 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-5 animate-in fade-in zoom-in-95 duration-150 my-8 relative z-[10000] max-h-[90vh] overflow-y-auto">
        {/* Header */}
